  ...
  return (
    <>
      <div className={`personal_details`}>
        ...
        <div className="box">
          <img src="/assets/img/Profile1.jpg" alt="Mithlesh" className="image-logo-menu" />
        </div>
        <h3 className="name_user">
          Chandan
          <span className="text-yellow">Kumar</span>
        </h3>
        ...
        <div className="sills_details">
          ...
          <div className="skills">
            <p>
              <span>Bootstrap</span> <span>90%</span>
            </p>
            <div className="progress">
          ...
          <div className="skills">
            <p>
              <span>Express.js</span> <span>60%</span>
            </p>
            <div className="progress">
              <div className="pro_div_in60"></div>
            </div>
        ...
        <div className="extra_know">
          ...
          <p>
            <i className="fa-solid fa-chevron-right"></i> Postman
          </p>
        </div>
